...
import me.meow.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Meow.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Meow.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Meow.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Meow.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
