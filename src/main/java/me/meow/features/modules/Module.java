package me.meow.features.modules;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = Meow.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Meow.moduleManager.getModuleByName(name);
